...
secrets:
	...
	pass services/vault/certs/client-user/cert > ansible/file/vault-client-user.crt
	pass services/vault/certs/client-user/privkey > ansible/file/vault-client-user.key
